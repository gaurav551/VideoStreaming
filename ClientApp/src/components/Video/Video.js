...
useEffect(() => {
  ...
  return (
    ...
    pathname: '/watch/'+id // , state : {id : id}
          ...
          <video id={"myVIdeo"+id} width='100%' src={`${videoName}?t=15`} alt=""/>
    ...
    pathname: '/watch/'+id , state : {id : id}
        ...
        <h4><Link to={{ pathname : '/channel/'+channelName }} title="">{channelName}</Link> <span className="verify_ic"><i className="icon-tick"></i></span></h4>
