...
namespace JWT.DEMO.Services
{
    public class UserService : IUserService
    {
        ...
        public async Task<(string,bool)> RegisterAsync(RegisterModel model)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return ($"User Registered with username {user.UserName}",true);
            ...
            {
                return ($"Email {user.Email} is already registered.",false);
            }
        }
        public async Task<AuthenticationModel> GetTokenAsync(TokenRequestModel model)
        {
            ...
            if (await _userManager.CheckPasswordAsync(user, model.Password))
            {
                ...
                authenticationModel.Message = $"You are logged in as {model.Email}";
                //Refresh Token END
                return authenticationModel;
            }
            else
